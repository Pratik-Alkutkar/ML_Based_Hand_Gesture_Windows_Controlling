...
model = load_model("D:/Engineering/7th_SEM/Project_Stage_2/Project_OG/handgesturemodel.h5")

# prepare the image
img = cv2.imread("D:/Engineering/7th_SEM/Project_Stage_2/Project_OG/MyImages/valid/down/down10.jpg")
...
while True:
     ...
     if user_gesture == "palm":
          cv2.putText(frame, "Opening Brave", (5, 50), FONT, 0.7, (0, 255, 255), 2, cv2.LINE_AA)
          engine.say(text3)
     ...
     #      engine.say(text2)
          ...
          cv2.putText(frame, "Opening Steam", (5, 50), FONT, 0.7, (0, 255, 255), 2, cv2.LINE_AA)
          engine.say(text6)
